...
This document provides a central hub for documenting raw data sources, the processed/transformed data, and feature sets (if applicable). More details of each dataset is provided in the data summary report. 
...
| Dataset Name | Original Location  | Destination Location | Description | 
| ---:| ---: | ---: | ---: | 
| Dataset 1 | Brief description of location | Brief description of destination | *Describe dataset* |
| Dataset 1 | Brief description of location | Brief description of destination | *Describe dataset* |
| Dataset 2 | Brief description of location | Brief description of destination | *Describe dataset* | 
